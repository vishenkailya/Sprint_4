...
class MainPageLocators:
    ...
    MAKE_ORDER_DOWN_BUTTON = (By.XPATH, "//div[contains(@class, 'Button_Button__ra12g Button_Middle__1CSJM)]/button[text()='Заказать']")
    SCOOTER_BUTTON = (By.XPATH, '//a[@class="Header_LogoScooter__3lsAR"]')
    YANDEX_DZEN_BUTTON = (By.XPATH, '//a[@class="Header_LogoYandex__3TSOI"]')
    LOCATOR_FAQ = (By.XPATH, '//div[@class="Home_FAQ__3uVm4"]')
